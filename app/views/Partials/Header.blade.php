<header class="bg-white-only header header-md navbar navbar-fixed-top-xs">
    ...
    <div class="navbar-header aside bg-success nav-xs">
        ...
        @if (isset($options->options['logo']) && Str::length($options->options['logo'] && $options->options['logo2']) && Str::length($options->options['logo2']) > 4)

		    <a class="navbar-brand text-lt" href="{{ route('home') }}">

		        <img id="visible-logo" src="{{ asset('assets/images/' . $options->options['logo']) }}" width="57" height="500">



		        <span class="hidden-nav-xs m-l-sm">

	                <img src="{{ asset('assets/images/' . $options->options['logo2']) }}" id="hidden-logo" alt="."  class="hide" style="margin-left: -20px">
    ...
    {{ Form::open(array('url' => Str::slug(trans('main.search')), 'method' => 'GET', 'class'=>'navbar-form navbar-left input-s-lg m-t m-l-n-xs hidden-xs', 'role'=>'search')) }}
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {{ Form::text('q', null, array('id' => 'auto-complete', 'class' => 'form-control input-sm no-border rounded auto-complete-search-box', 'placeholder' => trans('main.search placeholder'), 'data-url' => url('typeahead'))) }}
    ...
    @if(Helpers::hasAccess('super'))
        ...
        <div class="navbar-left" style="margin-left: 220px;">
