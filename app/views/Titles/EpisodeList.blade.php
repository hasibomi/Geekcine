                   ...
                   @include('Partials.Response')
                    ...
                    <div class="row">
                       <div class="col-md-12">
                            ...
                            @if ($data->getTrailer())
                                <a class="btn btn-info fancybox fancybox.iframe" style="margin-left: 2%;" href="{{{ $data->getTrailer() }}}">
                              ...
                              @if ($data->getType() == 'series')
                                ...
                                @foreach ($data->getSeasons() as $v)
                                  ...
                                  @if ($v->number == Request::segment(4))
                                    ...
                                    <a href="{{ Helpers::season($data->getTitle(), $v) }}" style="color: blue">{{{ $v->number }}}</a> |
