...
<div class="btn-group btns-under-jumbo center-block" style="background-color: {{ $data->getJumboMenuColor() }}">
  <ul>
    ...
    <li><a href="#watch" class="btn btn-default no-bord-right" data-toggle="tab"><i class="fa fa-video-camera visible-xs"></i><span class="hidden-xs">{{ trans('main.watchmovie') }}</span></a></li>
    @endif
  </ul>
