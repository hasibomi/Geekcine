...
class Title extends Eloquent
{
    ...
    public function getReleaseDateAttribute($value)
    {
        ...
        {
            return Carbon::createFromFormat('d-m-Y', $value)->toFormattedDateString();
        }
    ...
    public function scopeNowPlaying($query)
    {
        ...
        $playing = $query->where('now_playing', 1)->limit(12)->orderBy($order, 'desc')->get();
    ...
    {
        return $query->where('release_date', '>', Carbon::now()->toDateString())->limit(12)->get();
    }
